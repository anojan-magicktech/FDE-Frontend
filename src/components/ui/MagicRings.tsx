...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      ...
      if (currentColorStr !== p.color) {
        currentColorStr = p.color;
        uniforms.uColor.value.set(p.color);
      }
      if (currentColorTwoStr !== p.colorTwo) {
        currentColorTwoStr = p.colorTwo;
